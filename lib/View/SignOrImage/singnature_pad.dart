...
class SignatureState extends State<Signature> {
  ...
  Widget build(BuildContext context) {
    ...
    return ClipRect(
      child: CustomPaint(
        ...
        child: GestureDetector(onVerticalDragStart: _onDragStart, onVerticalDragUpdate: _onDragUpdate, onVerticalDragEnd: _onDragEnd, onPanStart: _onDragStart, onPanUpdate: _onDragUpdate, onPanEnd: _onDragEnd),
      ),
    );
  }
  ...
  void _onDragEnd(DragEndDetails details) => _points.add(Offset.infinite);
