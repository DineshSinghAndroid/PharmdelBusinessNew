...
import '../VirUploadScreens/VechileInspection_Report_Screen.dart';
                        ...
                        child: Padding(
                          ...
                          child: Column(children: [
                                ...
                                Row(
                                  children: [
                                    Container(
                                        height: 85,
                                        width: 85,
                                        decoration: BoxDecoration(boxShadow: [BoxShadow(color: AppColors.greyColor, blurRadius: 8, spreadRadius: 1, offset: const Offset(0, 0))], color: Colors.orangeAccent, borderRadius: BorderRadius.circular(50)),
                                        child: Center(
                                          child: BuildText.buildText(text: controller.driverProfileData?.data?.firstName != null && controller.driverProfileData!.data!.firstName!.isNotEmpty ? controller.driverProfileData!.data!.firstName![0].toString().toUpperCase() : "", color: AppColors.whiteColor, size: 30),
                                        )),
                                    buildSizeBox(0.0, 20.0),
                                    Expanded(
                                      child: BuildText.buildText(text: controller.driverProfileData?.data?.firstName ?? "", style: const TextStyle(fontSize: 18, color: Colors.black)),
                                    ),
                                      ...
                                      children: [
                                        ...
                                        Tooltip(
                                          ...
                                          child: SizedBox(
                                            ...
                                            child: FittedBox(
                                              fit: BoxFit.fill,
                                              child: Switch(onChanged: (bool value) => controller.onTapBreak(value: value), value: controller.onBreak, activeColor: AppColors.colorOrange, activeTrackColor: AppColors.colorOrange, inactiveThumbColor: AppColors.greyColor, inactiveTrackColor: AppColors.greyColor),
                                            ),
                                          ),
                                        ),
                                        BuildText.buildText(
                            ...
                            Visibility(
                              ...
                              child: WidgetCustom.drawerBtn(onTap: () => controller.onTapEnterMiles(), title: kEnterMiles, icon: Icons.edit),
                            ),
                            ...
                            WidgetCustom.drawerBtn(
                                onTap: () async {
                                  if (await InternetCheck.checkStatus() == false) {
                                    ...
                                    PopupCustom.showNoInternetPopUpWhenOffline(context: Get.overlayContext!, onValue: (value) {});
                                  } else {
                            ...
                            const Spacer(),
                            BuildText.buildText(text: kAppVersion + controller.versionCode ?? ""),
