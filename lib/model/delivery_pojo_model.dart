...
//
//     final deliveryPojoModal = deliveryPojoModalFromJson(jsonString);

import 'dart:convert';

List<DeliveryPojoModal> deliveryPojoModalFromJson(String str) => List<DeliveryPojoModal>.from(json.decode(str).map((x) => DeliveryPojoModal.fromJson(x)));

String deliveryPojoModalToJson(List<DeliveryPojoModal> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
