                ...
                children: <Widget>[
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      if (deliveryStatus.toLowerCase() == "outfordelivery" || deliveryStatus.toLowerCase() == "pickedUp" || deliveryStatus.toLowerCase() == "received")
                        Row(
                          children: [
                            if (isStorageFridge != "" && isStorageFridge.toLowerCase() == "t")
                              Container(
                                  height: 20,
                            ...
                            if (isControlledDrugs != "" && isControlledDrugs.toLowerCase() == "t")
                              Container(
                                height: 20,
                  ...
                  Row(
                    children: <Widget>[
                      ...
                      if (altAddress.toLowerCase() == "t")
                        Image.asset(strImgAltAdd,height: 18,width: 18, ),
