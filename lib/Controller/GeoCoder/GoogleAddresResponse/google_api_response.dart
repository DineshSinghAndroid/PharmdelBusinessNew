class GoogleAddressApiResponse {
  List<GoogleAddressResults>? results;
  String? status;

  GoogleAddressApiResponse({this.results, this.status});

  GoogleAddressApiResponse.fromJson(Map<String, dynamic> json) {
    if (json['results'] != null) {
      results = <GoogleAddressResults>[];
      json['results'].forEach((v) {
        results!.add(new GoogleAddressResults.fromJson(v));
      });
    }
    status = json['status'];
  }
...
class GoogleAddressResults {
  ...
  GoogleAddressResults.fromJson(Map<String, dynamic> json) {
