...
//   PmrModel({this.xml});
//
//   PmrModel.fromJson(Map<String, dynamic> json) {
...
//   Xml.fromJson(Map<String, dynamic> json) {
//
//     Sc? sc = json['xml'] != null ? new Xml.fromJson(json['xml']) : null;
//     Pa? patientInformat = json['xml'] != null ? new Xml.fromJson(json['xml']) : null;
//     Pb? doctorInformati = json['xml'] != null ? new Xml.fromJson(json['xml']) : null;
//     List<Dd>? dd;
//     DateTime? deliveryD  = json['xml'] != null ? new Xml.fromJson(json['xml']) : null;
//     String? deliveryNot
//     String? surgeryNote
//     String? recentDeliv
//     int? routeId;
